...
png("plot5.png")
g <- ggplot(aggregatedEmissions, aes(year, Emissions))
g <- g + geom_bar(stat = "identity") + ylab("Total PM2.5 Emissions") + ggtitle("Total ON-ROAD Emissions in Baltimore (1999 to 2008)")
print(g)
